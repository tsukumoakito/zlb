...
fn createTree(allocator: std.mem.Allocator, depth: i32) anyerror!*Node {
...
fn deleteTree(allocator: std.mem.Allocator, node: *Node) void {
    if (node.left) |l| deleteTree(allocator, l);
    if (node.right) |r| deleteTree(allocator, r);
